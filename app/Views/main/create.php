                    ...
                    <div class="card-body">
                        ...
                        <form name="createForm" id="createForm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Phone Number" name="phonenumber" id="phonenumber" class="form-control <?php echo (isset($validation) && $validation->hasError('phonenumber')) ? 'is-invalid' : ''; ?>" value="<?php echo set_value('phonenumber'); ?>">
